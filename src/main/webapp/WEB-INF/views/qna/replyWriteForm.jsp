	 	 ...
	 	 <div class="sub_content">
             <div class="content_wrap">
                 ...
                 <div class="page_table">
                      <div class="inner">                            
                          <form method="post" action="${path1 }/qna/replyinsert.do">
                              <table class="form_tb">
                                  <tbody>	
                                  	  <tr>
                                  	  	  <th>질문 제목</th>
                                      ...
                                      <tr>
                                          <th>답변 제목</th>
                                          <td>
                                          <input type="text" name="qtitle" id="qtitle" required></td>
                                      </tr>
                                      <tr>
                                          <th>답변 내용</th>
                                          <td>
                                      ...
                                      <tr>
                                          <th>작성자</th>
                                          <td>
                                          <input type="text" name="qwriter" id="qwriter" value=${sid } readonly>
