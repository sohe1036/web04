			...
			<div class="page_tit">
                 <div class="inner">
                     ...
                     <p>
                         ...
                         >
                         &nbsp;&nbsp;   
                         <span class="loca2">Q&A </span>
                     </p>
                 </div>    
             </div>
	         <div class="page_table">
                 <div class="inner">                            
                     <form method="post" action="${path1 }/qna/slist.do">
                     ...
                     <c:if test="${!empty sid }">
                     <div class="button">
                         <a href="${path1 }/qna/writeForm.do">문의하기</a>
                     </div>
                     </c:if>
					<table>
						<thead>
						...
						<c:forEach items="${qnaList }" var="qna">
							<tr>
								...
								</td>		<!-- dto에서는 String이므로 parseDate해주고 변수 qdate에 넣은 후  그 후 Date포멧해서 qdate 출력-->
							</tr>
						</c:forEach>	
						</tbody>
					</table>
