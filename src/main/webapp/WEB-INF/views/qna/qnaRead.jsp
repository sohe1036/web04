...
/*서브메뉴*/
    ...
    .button { float: right; display: inline-block; margin-top: 30px; }
    ...
    .btn { float: lift; width:120px; color: #fff; font-size: 15px;  padding: 10px 30px; background-color: #1f75b0; }
</style> 
</head>
<body>
<div class="wrap">
               ...
               <div class="sub_bg_menu">
	                ...
	                <div class="sub_bg_line">
	                    <div class="sub_bg_text">
	                     ...
	                     <a href="${path1 }/board/list.do"><b>Q&A</b></a>
	                    </div>
	                </div>          
	            </div>
               <div class="page_tit">
               ...
               <div class="page_table">
                   <div class="inner">
	                   <form action="${path1 }/qna/update.do" method="post">                            
	                         ...
	                         <c:if test="${!empty sid }">
	                           <tbody>
	                               ...
	                               <tr>
	                                   ...
	                                   <input type="hidden" name="qroot" id="qroot" value="${qna.qno }" />
	                                   <input type="hidden" name="qstep" id="qstep" value="0" />
	                                   <input type="hidden" name="qindent" id="qindent" value="0" />
	                                   </td>
	                                   </c:if>
	                               </tr>
	                               <tr>
                        ...
                        <div class="button">
                        	<c:if test="${qna.qwriter==sid or sid=='admin' }">
                        	 	<a href="${path1 }/qna/delete.do?qno=${qna.qno }">글 삭제</a>
                        	</c:if>
                        	 &nbsp;&nbsp;&nbsp;&nbsp;
                        	<c:if test="${sid=='admin' }">
                        		 <a href="${path1 }/qna/replyForm.do?qno=${qna.qno }">답변하기</a>
                        	</c:if>
                           	<a href="${path1 }/qna/list.do">글 목록</a>
                        </div>  
                   </div>
               </div>
            </div>    
