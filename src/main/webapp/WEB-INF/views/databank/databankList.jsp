...
<style>
 /*서브메뉴*/
    ...
    .page_tit .loca2 { color: #000; }
     ...
     .page_table .inner { width: 800px; margin: 0 auto; margin-top: 70px; }
     ...
     .page_table .th1, .page_table .th3 { width: 150px; }
			...
			<div class="page_tit">
	         ...
	         <div class="page_table">
                 <div class="inner">                            
                     ...
                     <c:if test="${sid=='admin' }">
                     <div class="button">
                         <a href="${path1 }/databank/writeForm.do">글 추가</a>
                     </div>
                     </c:if>
					<table>
						<thead>
