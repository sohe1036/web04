                              ...
                              <table class="form_tb">
                                  <tbody>
                                      ...
                                      <tr>
                                          <th>내용</th>
                                          <td>
                                              <textarea cols="100" rows="12" name="content" id="content" required></textarea>
                                          </td>
                                      </tr>
                                      <tr>
                                          <th>작성자</th>
                                          <td><input type="text" name="name" value="관리자" id="name" readonly></td>
                                      </tr>
                                      <tr>
                                          <td colspan="2">
