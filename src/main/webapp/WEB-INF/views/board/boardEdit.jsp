                              ...
                              <table class="form_tb">
                                  <tbody>
                                      ...
                                      <tr>
                                          <th>내용</th>
                                          <td>
                                              <textarea cols="100" rows="12" name="content" id="content" required>${board.content }</textarea>
                                          </td>
                                      </tr>
                                      <tr>
                                          <th>작성자</th>
                                          <td>
                                          ${board.name }
                                          <input type="hidden" name="name" value="관리자" id="name" value="${board.name }">
                                          </td>
                                      </tr>
                                      <tr>
                                  	  	  <th>작성일</th>
